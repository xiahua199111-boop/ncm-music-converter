...
## ⚖️ 免责声明
   本项目核心算法逻辑参考了 GitHub 社区已有的 ncmdump 实现，本人主要完成了基于 Flask 的 Web 界面封装与本地环境适配优化。

   本工具仅供个人学习 Python 加解密流处理技术使用，请勿用于商业用途。

   支持正版音乐，请在测试后 24 小时内删除相关文件。用户因非法使用本工具而产生的任何纠纷，由用户本人承担。
